...
struct OnboardingView: View {
    ...
    private var permissionsStep: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Activa estos permisos para usar Speex con una experiencia completa.")
                .foregroundColor(.secondary)

            if appState.needsMicrophone || appState.needsAccessibility {
                Label("Activa ambos permisos para usar Speex sin bloqueos.", systemImage: "exclamationmark.triangle.fill")
                    .font(.callout)
